...
- **Rassembler les objets statiques avec les mêmes matériaux** sur chaque Stand pour limiter le nombre de draw calls. ***Les objets des 3 stands détachés = 170 fps, une fois attachés = 390 fps !***
